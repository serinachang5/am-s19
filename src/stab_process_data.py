...
PATH_TO_TRAIN_TEST_SPLIT = '../0.stab_essays/raw_download.0/train-test-split.csv'
PATH_TO_RAW_CORPUS = '../0.stab_essays/raw_download.0/brat-project-final/'
PATH_TO_PROCESSED_CORPUS = '../0.stab_essays/processed/'
